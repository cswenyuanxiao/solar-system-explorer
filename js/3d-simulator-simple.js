/**
 * Simple 3D Solar System Simulator
 * A basic 3D solar system visualization using Three.js
 */
...
class SimpleSolarSystemSimulator {
    constructor() {
        this.scene = null;
        this.camera = null;
        this.renderer = null;
    ...
    async init() {
        try {
            ...
            console.log('Simple 3D Simulator initialized successfully');
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', () => {
    new SimpleSolarSystemSimulator();
}); 