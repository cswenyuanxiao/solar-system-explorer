// Quiz System for Solar System Education
...
class QuizSystem {
    ...
    loadQuestions() {
        return [
            // Basic Planet Knowledge
            {
                ...
                correct: 1,
                explanation: 'Mercury is the closest planet to the Sun, with an average distance of 57.9 million kilometers.',
                points: 10
            },
            {
                id: 2,
            ...
            },
            {
                ...
                correct: 1,
                explanation: 'Saturn has 146 confirmed moons, making it the planet with the most satellites in our solar system.',
                points: 15
            },
            {
                id: 4,
                ...
                category: 'basic',
                difficulty: 'easy',
                question: 'Earth is the only planet in our solar system known to have life.',
                options: ['True', 'False'],
                correct: 0,
                explanation: 'True! Earth is the only planet where life has been confirmed to exist.',
                points: 10
            },
            {
                id: 5,
                ...
                correct: 1,
                explanation: 'Venus has the highest surface temperature, averaging 462°C due to its thick greenhouse atmosphere.',
                points: 20
            },
            {
                id: 6,
                ...
                correct: 1,
                explanation: 'Jupiter is the largest planet, with a diameter of 139,822 kilometers.',
                points: 15
            },
            {
                id: 7,
                ...
                correct: 0,
                explanation: 'Uranus rotates on its side with an axial tilt of 98 degrees.',
                points: 20
            },
            {
                id: 8,
                ...
                options: ['True', 'False'],
                correct: 0,
                explanation: 'True! The Sun is a G-type main-sequence star (yellow dwarf).',
                points: 10
            },
            {
                id: 9,
        ...
        quizContainer.innerHTML = `
            <div class="quiz-header">
                ...
                <div class="quiz-progress">
                    <span id="questionCounter">Question 1 of ${this.questions.length}</span>
            ...
            <div class="quiz-content">
                ...
                <div class="quiz-controls">
                    ...
                    <button id="submitBtn" class="quiz-btn" style="display: none;">Submit Quiz</button>
                </div>
            </div>
    ...
    displayResults() {
        ...
        if (percentage >= 90) {
            grade = 'A+';
            message = 'Excellent! You\'re a solar system expert!';
            ...
            grade = 'D';
            message = 'Keep studying the solar system!';
        }
        ...
        quizResults.innerHTML = `
            <div class="results-card">
                ...
                <div class="score-display">
                    ...
                    <div class="grade">${grade} (${percentage}%)</div>
                </div>
                ...
                <div class="quiz-actions">
                    <button id="retakeQuiz" class="quiz-btn">Retake Quiz</button>
                    <button id="backToLearning" class="quiz-btn">Back to Learning</button>
                </div>
            </div>
        `;
        ...
        document.getElementById('backToLearning').addEventListener('click', () => {
